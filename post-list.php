...
$query="SELECT * FROM articles WHERE status='1' ORDER BY date DESC LIMIT " . $this_page_first_result . ',' . $results_per_page;
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <?php if($page > 1){ ?>
            <li class="page-item">
              <a class="page-link" href="post-list-<?php echo $previous_page;?>">&larr; Older</a>
            </li>
          <?php }else {?> 
          ...
          <?php if($page < $number_of_pages){ ?>
            <li class="page-item">
              <a class="page-link" href="post-list-<?php echo $next_page;?>">Newer &rarr;</a>
            </li>
            <?php }else {?> 
              <li class="page-item disabled">
